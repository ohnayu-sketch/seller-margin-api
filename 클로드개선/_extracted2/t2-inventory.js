    ...
    return `<div class="t2-pcard">
        ...
        <div class="t2-pcard-body">
            ...
            <div class="t2-pcard-actions">
                ...
                <button class="t2-act-btn" onclick="t2SendToStudio('${p.id}')">T5</button>
...
function t2RenderProductRow(p) {
    ...
    return `<tr>
        ...
        <td>
            <button class="t2-mini-btn" onclick="t2SendToStudio('${p.id}')">T5</button>
...
function t2ShowPendingQueue() {
    ...
    el.innerHTML = T2.pendingQueue.map((item, idx) => `
        <div class="t2-pending-row">
            ...
            <button class="t2-act-btn" onclick="t2SendPendingToStudio(${idx})">T5</button>
